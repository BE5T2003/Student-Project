...
try {
    ...
    die("Error fetching course offerings: " . $e->getMessage());
}
?>
<!DOCTYPE html>
<html lang="th">
<head>
    ...
    <title>รายงานรายวิชาเปิดสอน - Suan Dusit University</title>
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?php echo number_format($course['current_students']); ?></td>
                                <td>
                                    <?php 
                        ...
                        <?php if (empty($courses)): ?>
                            <tr>
                                <td colspan="8" class="text-center">ไม่มีรายวิชาเปิดสอนในภาคการศึกษานี้</td>
                            </tr>
                        <?php endif; ?>
                    </tbody>
                </table>
